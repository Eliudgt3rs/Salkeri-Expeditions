...
export default function WhatsappButton() {
  ...
  return (
    <Link 
      ...
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#128C7E] transition-colors text-white rounded-full p-3 shadow-lg flex items-center justify-center gap-2"
